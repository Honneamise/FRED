...
The library reference for standard routines is available in the [LIBRARY](DOCS/LIBRARY.MD) section.
...
- implementing the original library for arithmethic subroutines
- dma
- block devices
